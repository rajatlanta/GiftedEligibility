...
import { Grade, School, Student } from 'src/model/common';
...
export class EligibilityComponent implements OnInit {
  ...
  ActivateSurveyQuestionsComp : boolean = false;
  ...
  AddEligibility(gtID: string, studentName: string)
  {
    ...
    this.selectedGTID = gtID;
    this.selectedStudentName = studentName;
    this.ActivateSurveyQuestionsComp = true;
  ...
  hideModel()
  {
    this.ActivateSurveyQuestionsComp = false;
  ...
  ViewEligibility(gtID: string, studentName: string)
  {
    ...
    console.log("GTID:" + gtID);
    console.log("StudentName:" + studentName);
    /*sessionStorage.setItem('MyName', 'Moota');
    this.router.navigate(['/eligibilityDetails']);*/
  }
